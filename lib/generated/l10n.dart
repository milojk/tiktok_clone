...
class S {
  ...
  String signUpTitle(String nameOfTheApp, DateTime when) {
    final DateFormat whenDateFormat =
        DateFormat('y / QQQQ / LLLL : Hm', Intl.getCurrentLocale());
    ...
    return Intl.message(
      ...
      name: 'signUpTitle',
      desc:
          'The title that people see when they open the app for the first time.',
  ...
  String loginTitle(String nameOfTheApp) {
    return Intl.message(
      'Log into your $nameOfTheApp account',
      name: 'loginTitle',
      desc: 'The title that people see when they login the app.',
      args: [nameOfTheApp],
    );
  }
  ...
  String likeCount(int potato) {
    ...
    return Intl.message(
      '$potatoString',
      name: 'likeCount',
      desc: 'The number of likes pressed by users.',
      args: [potatoString],
    );
  }
  ...
  String commentCount(int potato) {
    ...
    return Intl.message(
      '$potatoString',
      name: 'commentCount',
      desc: 'The number of comments made by users.',
      args: [potatoString],
    );
  }
